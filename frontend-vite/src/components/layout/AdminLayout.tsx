            ...
            {mobileMenuOpen && (
                <div className="lg:hidden fixed inset-0 z-20 bg-stone-100 pt-16 flex flex-col">
                    <nav className="flex-1 p-4 space-y-2">
                        ...
                        <Link to="/admin/parceiras" onClick={() => setMobileMenuOpen(false)} className="block p-4 rounded-xl text-text font-ui font-medium bg-white shadow-sm border border-border-light">Parceiras</Link>
                        <Link to="/admin/campanhas" onClick={() => setMobileMenuOpen(false)} className="block p-4 rounded-xl text-text font-ui font-medium bg-white shadow-sm border border-border-light">Campanhas</Link>
